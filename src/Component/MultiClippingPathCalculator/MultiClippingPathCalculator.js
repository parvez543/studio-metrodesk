...
const MultiClippingPathCalculator = () => {
    ...
    const handleOnClick = (event) => {
        ...
        if(hours === 20){
            console.log((numberValue* selectedOption) + (numberValue * shadows) * 2);
            // setValue((numberValue* selectedOption) + (shadows + 1)
            setValue((numberValue* selectedOption) + (numberValue * shadows) * 2);
        }

        if(hours === 10){
            let initaialvalue = ((numberValue* selectedOption) + (numberValue * shadows) * 2)
    ...
    return (
        <div className='container mx-auto px-10 lg:px-56 py-20'>
            ...
            <div className='mt-12 bg-white hover:bg-slate-200 rounded-lg shadow-lg lg:w-[300px]'>
                <form onSubmit={handleOnClick}>
                    ...
                    <div>
                        <input type="number" className='input input-bordered lg:w-[239px] mb-4' name="number"></input> <br />
                        <div className='mb-4'>
                            <select name="option" className="select w-full input input-bordered lg:w-[239px]">
                        ...
                        <div className='mb-4'>
                            <select name="shadows" className="select w-full input input-bordered lg:w-[239px]">
                        ...
                        <div className='mb-4'>
                            <select name="hours" className="select w-full input input-bordered lg:w-[239px]">
                    ...
                    <p className='text-blue-700 text-xl font-semibold'> TOTAL QUOTATION</p>
                    <p className='text-blue-700 text-xl font-semibold'>${value}</p>
                    <div>
