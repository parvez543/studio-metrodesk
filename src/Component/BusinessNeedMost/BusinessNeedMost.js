...
import productPhotography from "../../assets/images/ecom-photo-editing-service-back-to-work.jpg"

const BusinessNeedMost = () => {
    return (
        ...
        <div className='container mx-auto px-10 lg:px-20 2xl:px-48 py-20'>
            <div className='grid lg:grid-cols-2'>
                ...
                <div>
                    <h2 className='mb-5 text-3xl sm:text-4xl md:text-5xl font-medium text-[#7A80BD] text-left'>Get Back To Business That Needs You The Most</h2>
...
export default BusinessNeedMost;