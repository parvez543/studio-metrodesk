...
import photoEditing from "../../assets/images/groing-brand2.jpg"

const PhotoEditingInclude = () => {
    return (
        <div className='container mx-auto px-10 lg:px-56 py-20'>
                ...
                <p className='text-lg text-gray-700 mb-3 text-left'>We help brands with basic to high-end photo editing, whatever they need.</p> 
...
export default PhotoEditingInclude;