...
const ContactForm = () => {
    ...
    return (
        <div className='container mx-auto px-10 lg:px-56 py-20'>
            ...
            <div className='grid  grid-cols-1 lg:grid-cols-2 justify-items-center gap-14'>
                <div className='mt-12'>
                    <form className='text-left' onSubmit={handleOnSubmit}>
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
                            ...
                            <div className='flex flex-col '>
                                ...
                                <div>
                                    <select name="option" className='selectOption border-l lg:w-[245px] border-indigo-400'>
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6'>
                            <div className='flex flex-col'>
                                ...
                                <input type="email" placeholder="Your Email" name="email" className="w-full py-3 px-3  border-l border-indigo-400 bg-[#F2F2F2]" required />
                            </div>
                            <div className='flex flex-col'>
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6'>
                            <div className='flex mt-6 mb-2 flex-col'>
                                ...
                                <select name="numberRange" className='selectOption  border-l border-indigo-400'>
                                    {
                                        imageEdit?.map(i => <>
                                            <option value={i.name}>{i.name}</option>
                                        </>)
                            ...
                            <div className='flex mt-6 mb-2 flex-col'>
                                ...
                                <select name="imageEdit" className='selectOption  border-l border-indigo-400'>
                                    {
                                        imageDuration?.map(i => <>
                                            <option value={i.name}>{i.name}</option>
                                        </>)
