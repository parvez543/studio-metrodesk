...
import "./MultiClippingPathExperts.css"
import productPhotography from "../../assets/images/services/multiple-clipping-path/Multiple_Professional.jpg"

const MultiClippingPathExperts = () => {
    return (
...
export default MultiClippingPathExperts;