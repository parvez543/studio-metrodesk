    ...
    return (
        <div className='contentContainer'>
            <div className='container mx-auto px-10 lg:px-20 2xl:px-56 py-20'>
                <div className='flex flex-col-reverse lg:flex-row items-start gap-12'>
                    ...
                    <div className='flex'>
                        ...
                        <div>
                            ...
                            <p className='w-full mt-5 text-lg text-gray-500 font-light lg:w-[500px] lg:ml-10 text-left'>"I tried two other companies before Studio Metrodesk, and their work was sub-par?. These guys are doing an amazing job and their work is always done on time. I've been using them for years and they have never failed to deliver fantastic results.
                ...
                <div className='mt-6 lg:-mt-20 flex items-center gap-6'>
                    <div>
