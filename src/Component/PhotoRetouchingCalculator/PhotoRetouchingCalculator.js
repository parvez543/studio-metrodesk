...
import photoretouch from "../../assets/images/price_page/clipping_path.png"

const PhotoRetouchingCalculator = () => {
        ...
        <div className='mt-12 bg-white hover:bg-[#fdfddc] rounded-lg calculator 2xl:w-[300px]'>
            <form onSubmit={handleOnClick}>
                <div>
                    ...
                    <div className='mb-4'>
                        <img className='pricingImg' src={photoretouch} alt="Studio MetroDesk Clipping Path Service" />
                    </div>
                    <div className='flex justify-center'>
                        <p className='dollar-sign'>$</p>
                        <p className='price-text'>03</p>
                    </div>
                ...
                <div>
                    ...
                    <div className='mb-4'>
                        <select name="option" className="select input input-bordered w-[239px]">
                            ...
                            <option value="5">Background Retouch - $5</option>
                            <option value="7">Ring Retouch - $7</option>
                            <option value="7">Cosmetics Retouch - $7</option>
                            <option value="10">Watch Retouch -  $10</option>
                            <option value="15">Mix Product Retouch - $15</option>
                        </select>
                    </div>
                    <div className='mb-4'>
...
export default PhotoRetouchingCalculator;