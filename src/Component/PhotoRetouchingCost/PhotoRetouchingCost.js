            ...
            <div className='container mx-auto px-10 lg:px-56 py-20'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 mt-14'>
                    <div>
                        ...
                        <p className='text-xl text-gray-700 mb-3 text-left lg:w-[450px]'>To make online shoppers take their credit cards out, you need more than ordinary product photos. This is where high-quality product photo editing comes into play to make the ordinary extraordinary, as good editing will let you showcase your products as best as possible.</p>
                        <p className='text-xl text-gray-700 mb-3 text-left lg:w-[450px]'>We optimize your product photos exactly how you want them presented on your website and brand merchandising. Our main focus is to apply the best photo editing techniques and bring out eye-catching product photos that boost your sales.</p>
                    </div>
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 items-center justify-center'>
                        <div className='w-full flex justify-center items-center mb-6 lg:mb-0'>
