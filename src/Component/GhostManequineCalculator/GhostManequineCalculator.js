...
import ghostmanequine from "../../assets/images/price_page/ghost_mannequin.png"

const GhostManequineCalculator = () => {
        ...
        <div className='mt-12 bg-white hover:bg-[#fdfddc] rounded-lg calculator lg:w-[300px]'>
            <form onSubmit={handleOnClick}>
                <div>
                    ...
                    <div className='mb-4'>
                        <img className='pricingImg' src={ghostmanequine} alt="Studio MetroDesk Ghost Manequine Service" />
                    </div>
                    <div className='flex justify-center'>
                        <p className='dollar-sign'>$</p>
                        <p className='price-text'>1.5</p>
                    </div>
                ...
                <div>
                    ...
                    <div className='mb-4'>
                        <select name="option" className="select input input-bordered w-[239px]">
                            ...
                            <option value="1.5">Simple - $1.5</option>
                            <option value="2.5">Complex - $2.5</option>
                    ...
                    <div className='mb-4'>
                        <select name="shadows" className="select input input-bordered w-[239px]">
                            ...
                            <option value="0">Drop Shadow Free</option>
                            <option value="0">Custom Shadow Free</option>
...
export default GhostManequineCalculator;