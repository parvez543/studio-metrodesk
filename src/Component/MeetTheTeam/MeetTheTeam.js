            ...
            <div className='container mx-auto px-10 lg:px-56'>
                <div className='flex items-center'>
                    <div className='flex flex-col justify-start'>
                        ...
                        <p className='block mx-auto text-xl pt-2 px-10 lg:px-0 pb-12 text-left'>Meet the people behind Studio Metrodesk. See who's editing your photos, answering your calls, enhancing your experience and constantly making sure pixel-perfect outputs.</p>
                        <div>
