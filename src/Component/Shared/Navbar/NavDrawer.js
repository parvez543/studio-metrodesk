                ...
                <div className='h-full w-full'>
                    ...
                    <div className='w-full h-full mt-10'>
                        <div className='flex flex-col text-lg font-semibold gap-10 w-full h-full ml-10'>
                            ...
                            <div className='flex gap-2'>
                                <Link to='/shop' onClick={() => setIsOpen(false)} className='uppercase hover:text-gray-400 ease-in-out duration-300'>Blogs</Link>
                                <div className='flex flex-col'>
                                    <button onClick={toggle2} className="mt-1">{!open2 ? <AiOutlinePlus /> : <AiOutlineMinus />}</button>
                                    <>{open2 &&
                                        <div className='relative right-14 mt-6'>
                                            <h2 className='uppercase font-semibold mb-3 text-base'><u>Categories</u></h2>
                                            <div className='grid grid-cols-1 gap-2'>
