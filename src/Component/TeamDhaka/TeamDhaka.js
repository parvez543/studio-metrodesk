...
const TeamDhaka = () => {
    return (
        <div className='bg-[#F5F6FF]'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:px-56 lg:px-[355px] justify-items-center'>
                {
                    dhaka?.map(d => <>
                        <div className=''>
                        <img src={d.img} alt="Studio MetroDesk Team Dhaka Picture"/>
